...
if __name__ == '__main__':
 ...
 history = model_seq.fit(train_x, train_y, batch_size=64, epochs=150, shuffle=True, validation_data=(val_x, val_y), callbacks=[checkpointer,earlystopper])
